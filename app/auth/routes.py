...
from app.models import RegistrationSchema, LoginSchema
...
RegistrationSchema.validate_username = validate_username
...
def register():
    if request.method == 'POST':
        ...
        validated_data = RegistrationSchema().load(data)
        users_collection = mongo.db.users
